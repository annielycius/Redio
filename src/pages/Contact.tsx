    ...
    <div className="min-h-screen bg-[#1A1F2C] text-white flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 animate-fade-in">
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          <h2 className="text-2xl font-semibold text-white/90">Annie Webester James</h2>
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-3 text-lg">
              ...
              <a href="mailto:URIOMAXMILLIAN@GMAIL.COM" className="text-primary hover:underline">
                anniewebesterjames2018@gmail.com
              </a>
            </div>
            <div className="flex items-center gap-3 text-lg">
              <Send className="w-6 h-6 text-primary" />
              <a href="https://t.me/annielycius" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                @annielycius
              </a>
