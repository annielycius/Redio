      ...
      <main className="flex-1 container mx-auto px-4 py-8 animate-fade-in">
        ...
        <div className="prose prose-invert max-w-none space-y-6">
          <p className="text-lg text-white/80">
            Welcome to my online radio streaming platform! (Bongo Radio) This website is developed just for fun as part of a Computer Science learning curve at Institute of Accountancy Arusha (IAA). By using this platform, you agree to the terms outlined in this privacy policy. I am committed to providing a free and accessible service while respecting the rights of radio station owners.
          </p>
          ...
          <p className="text-lg text-white/80">
            This platform is just my fun student project created as part of a Computer Science curriculum (Web design) at Institute of Accountancy Arusha (IAA). It is intended solely for educational purposes and not for commercial use.
          </p>
          ...
          <p className="text-lg text-white/80 mt-8">Thank you for using Bongo Radio streaming service!</p>
        </div>
      </main>
