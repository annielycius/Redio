      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white/80"> by Annie Webester James, in Tanzania</span>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <a
              href="https://www.facebook.com/annie webester james"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 text-white/80 hover:text-primary transition-all transform hover:scale-110"
            >
          ...
          <div className="flex flex-col items-center gap-4 text-sm text-white/60">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="tel:+255767233231" className="hover:text-primary">+255 767 233 231</a>
            </div>
          </div>
        </div>
      </div>
